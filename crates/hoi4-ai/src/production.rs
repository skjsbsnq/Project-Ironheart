...
mod tests {
    ...
    fn test_v6_db() -> V6Database {
        ...
        db.buildings.push(BuildingDef {
            ...
            economic_sector: EconomicSectorDef::MilitarySupport,
            gameplay_class: BuildingGameplayClassDef::MilitaryIndustry,
            gdp_rule: BuildingGdpRuleDef {
                component: BuildingGdpComponentDef::MilitaryProcurement,
