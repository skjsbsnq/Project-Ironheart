...
impl Historical1936Database {
    pub fn load() -> Result<Self, ron::error::SpannedError> {
        let countries = vec![
            ...
            load_ron(include_str!("../content/history_1936/countries/AUS.ron"))?,
            load_ron(include_str!("../content/history_1936/countries/LIT.ron"))?,
            load_ron(include_str!("../content/history_1936/countries/POL.ron"))?,
